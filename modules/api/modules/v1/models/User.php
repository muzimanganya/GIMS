...
class User extends \yii\db\ActiveRecord
{
    ...
    const ROLE_FUEL = 101;
    const ROLE_ADMIN = 103;
    const ROLE_CASHIER = 104;
    const ROLE_DRIVER = 105;
    const ROLE_GARAGE = 106;
    const ROLE_MEAL = 107;
    const ROLE_PARKING = 108;
    const ROLE_CARWASH = 109;
    const ROLE_LEASING = 110;
    const ROLE_FINE = 111;
     ...
     public static function getRoles()
    {
        return [
            ...
            self::ROLE_FUEL => Yii::t('app', 'Fuel Agent'),
            
            self::ROLE_CASHIER => Yii::t('app', 'Cashier'),
            self::ROLE_DRIVER => Yii::t('app', 'Drivers Agent'),
            self::ROLE_GARAGE => Yii::t('app', 'Garage Agent'),
            self::ROLE_MEAL => Yii::t('app', 'Meal Stipends Agent'),
            self::ROLE_PARKING => Yii::t('app', 'Parking Agent'),
            self::ROLE_CARWASH => Yii::t('app', 'Car Wash Agent'),
            self::ROLE_LEASING => Yii::t('app', 'Car Leasing Agent'),
             self::ROLE_FINE => Yii::t('app', 'Car Fine Agent'),
        ];
    }
